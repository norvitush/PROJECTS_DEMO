...
namespace EzySlice {
    ...
    public sealed class SlicedHull {
        ...
        public GameObject CreateUpperHull(GameObject original, Material crossSectionMat, Transform _parent = null) {
            GameObject newObject = CreateUpperHull(_parent);
        ...
        public GameObject CreateLowerHull(GameObject original, Material crossSectionMat,Transform _parent=null) {
            GameObject newObject = CreateLowerHull(_parent);
         ...
         */
        public GameObject CreateUpperHull(Transform _parent = null) {
            return CreateEmptyObject("Upper_Hull", upper_hull, _parent);
        }
         ...
         */
        public GameObject CreateLowerHull(Transform _parent = null) {
            return CreateEmptyObject("Lower_Hull", lower_hull, _parent);
        }
        ...
        private static GameObject CreateEmptyObject(string name, Mesh hull,Transform _par = null)
        {
            if (hull == null)
            {
                return null;
            ...
            if (_par != null)
            {
                newObject.transform.parent = _par;
            }
