...
namespace VOrb.CubesWar
{
    ...
    public class GameService : Singlton<GameService>
    {
        ...
        public static ITouchSensetive ActiveNow;
        ...
        public GunDriver GunController;
        ...
        public void ReceiveContainers()
        {
            ...
            TopUIContainer = SceneLoader.sceneSettings.TopUIContainer;
        ...
        public void LoadFields()
        {
            ...
            JoystikContainer JoystikParent = SceneLoader.sceneSettings.TopUIContainer.GetComponentInChildren<JoystikContainer>();
            GameJoystik = JoystikParent.gameObject.transform.GetComponentInChildren<Joystik>();
            GameJoystik?.Init();
            GunController = GunContainer.GetComponentInChildren<GunDriver>();
