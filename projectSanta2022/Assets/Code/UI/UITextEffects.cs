        ...
        public static void SplashMainScreen(string sp_Text, TextEffectPreset preset, bool needToSplit = false)
        {
            ...
            SplashText.text = needToSplit ? Instance.GetSplitedLines(sp_Text) : sp_Text;
                ...
                if (preset.Movable)
                {
                    ...
                    RectTransformUtility.ScreenPointToWorldPointInRectangle((RectTransform)GameService.UIMainWindowContainer.transform, preset.ScreenPosition, Camera.main, out txt_position);
